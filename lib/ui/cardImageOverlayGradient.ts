/** Overlay inferior para cards con imagen y texto superpuesto (no noticias). */
...
/** Overlay para cards de empresas del sector Servicios Financieros. */
...
/** Overlay del poster de video en la sección I3 (Innovación para el desarrollo). */
export const I3_VIDEO_POSTER_OVERLAY_GRADIENT =
  'linear-gradient(20deg, rgba(0, 0, 0, 0.60) 18.8%, rgba(0, 0, 0, 0.00) 86.67%)';
