export const HOME_HERO_HEIGHT_CLASS =
  'h-[380px] min-h-[380px] max-h-[380px] md:h-[419px] md:min-h-[419px] md:max-h-[419px]';
...
export const HOME_HERO_WRAPPER_CLASS =
  `relative flex w-full flex-col overflow-hidden ${HOME_HERO_HEIGHT_CLASS}`;
