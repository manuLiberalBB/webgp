...
import { SectorCompanyCard } from '@/components/sections/sectors/SectorCompanyCard';
...
export function StrategicSectorRelatedCompanies({
  ...
  return (
    <section className={cn('flex w-full flex-col gap-5 md:gap-12', className)}>
      ...
      <div className="grid grid-cols-1 items-stretch gap-5 layout-md:grid-cols-2 layout-lg:grid-cols-3">
        {items.map((item) => (
