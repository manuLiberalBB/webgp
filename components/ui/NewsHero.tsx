...
export function NewsHero({
  ...
  return (
    <section
      className={cn(
        'relative flex w-full min-h-[340px] flex-col md:min-h-[400px]',
        className,
      )}
    >
      <Image
      ...
      <div className="relative z-10 w-full px-6 md:px-layout-x">
        <div className="mx-auto flex w-full max-w-news-article flex-col items-start gap-4 pb-6 pt-6 md:gap-5 md:pb-8 md:pt-9">
